function P2=makestimRCM(P);
% MakestimRCM - stimulus generator for RCM stimGUI
%    P=MakestimRCM(P), where P is returned by GUIval, generates the stimulus
%    specified in P. MakestimRCM is typically called by StimGuiAction when
%    the user pushes the Check, Play or PlayRec button.
%    MakestimRCM does the following:
...
%          stimulus duration, Max RCM, etc.
%
%    MakestimRCM renders P ready for D/A conversion by adding the following 
%    fields to P
