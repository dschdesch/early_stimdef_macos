function Params = stimdefQFM(EXP)
% stimdefQFM - definition of stimulus and GUI for RAM stimulus paradigm
%    P=stimdefQFM(EXP) returns the definition for the RAM (Response Area Modulation)
...
% ---SAM sweep
Samsweep = SAMstepper('QFM', EXP, '', 0); % don't include theta
...
Params = add(Params, PlayTime, below(freqPanel) , [0 50]);
