function condBurstDursweep=condBurstDurstepper(T, EXP, Prefix, Flag, Flag2);
...
%      EndW: end condBurstDur in Hz or in octave
%        AdjustFreq: toggle selecting which of the above params to adjust
%                    in case StepcondBurstDur does not fit exactly.
...
%==========condBurstDur GUIpanel=====================
condBurstDursweep = GUIpanel('condBurstDursweep', T);
StartcondBurstDur = ParamQuery([Prefix 'StartcondBurstDur'], 'start:', FreqEditSizeString, 'ms', ...
    'rreal/positive', ['Starting condBurstDur of series.' PairStr], Nchan);
StepcondBurstDur = ParamQuery([Prefix 'StepcondBurstDur'], 'step:', '2', {'ms' 'Octave'}, ...
    'rreal/positive', ['condBurstDur step of series.' ClickStr 'step units.'], Nchan);
EndcondBurstDur = ParamQuery('EndcondBurstDur', 'end:', FreqEditSizeString, 'ms', ...
    'rreal/positive', ['Last condBurstDur of series.' PairStr], Nchan);
AdjustcondBurstDur = ParamQuery([Prefix 'AdjustcondBurstDur'], 'adjust:', '', {'none' 'start' 'step' 'end'}, ...
...
condBurstDursweep = add(condBurstDursweep, StartcondBurstDur);
condBurstDursweep = add(condBurstDursweep, StepcondBurstDur, alignedwith(StartcondBurstDur));
condBurstDursweep = add(condBurstDursweep, EndcondBurstDur, alignedwith(StepcondBurstDur));
condBurstDursweep = add(condBurstDursweep, AdjustcondBurstDur, nextto(StepcondBurstDur), [10 0]);
if ~isequal('notol', Flag),
    condBurstDursweep = add(condBurstDursweep, Tol, alignedwith(AdjustcondBurstDur) , [0 -10]);
end