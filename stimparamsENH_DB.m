...
%   
%    StimparamsNPHI is called by stimGUI dur    ing the preparation of the 
...
T.BurstDur = ones(Ncond,2)*(S.condBurstDur+S.testBurstDur+S.delta_T);
