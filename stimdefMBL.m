function Params = stimdefMBL(EXP)
% stimdefMBL - definition of stimulus and GUI for MBL stimulus paradigm
%    P=stimdefMBL(EXP) returns the definition for the MBL (Rate Curve Modulation)
%    stimulus paradigm. The definition P is a GUIpiece that can be rendered
%    by GUIpiece/draw. Stimulus definition like stimdefMBL are usually
...
%    side, etc.
%
%    See also stimGUI, stimDefDir, Experiment, makestimMBL.

PairStr = ' Pairs of numbers are interpreted as [left right].';
ClickStr = ' Click button to select ';
%==========SPL Stepper GUIpanel=====================
SPLsweep = SPLstepperMBL('-', EXP);
