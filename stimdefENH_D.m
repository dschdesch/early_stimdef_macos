...
% ---Pres
Pres = PresentationPanel_XY('W', 'delta_T');

summ = Summary(19);
%====================
Params=GUIpiece('Params'); % upper half of GUI: parameters
Params = add(Params, summ);
Params = add(Params, delta_Tsweep, nextto(summ), [10 0]);
Params = add(Params, Wsweep, nextto(delta_Tsweep) ,[120 0]);

Params = add(Params, Miscl, nextto(Wsweep) ,[0 0]);
Params = add(Params, Levels, below(Miscl) ,[-150 20]);
Params = add(Params, durC, below(delta_Tsweep) ,[10 0]);
